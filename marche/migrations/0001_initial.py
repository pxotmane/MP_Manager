        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type_budget",
                    models.CharField(
                        choices=[("INV", "Investissement"), ("EXP", "Exploitation")],
                        max_length=5,
                ...
                (
                    "titulaire",
                    models.CharField(
                        max_length=255, verbose_name="Titulaire du marché"
                    ),
                ),
                (
                    "mode_passation",
                    models.CharField(
                        choices=[
                            ...
                            ("AOS", "Appel d'offres ouvert simplifié"),
                            ("AOP", "Appel d'offres avec présélection"),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("MARCHE_CADRE", "Marché cadre"),
                            ("MARCHE_RECONDUCTIBLE", "Marché reconductible"),
                            ("MARCHE_ALLOTIS", "Marché alloti"),
                            (
                            ...
                            ("OFFRE_SPONTANEE", "Offre spontanée"),
                        ],
                        max_length=35,
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        db_index=True, verbose_name="Exercice budgétaire"
                    ),
                ),
                (
                    "rib",
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        null=True,
                        verbose_name="Date de notification d'approbation",
                    ),
                ),
                (
                    "delai_execution",
                ...
                (
                    "marche_solde",
                    models.BooleanField(default=False, verbose_name="Marché soldé"),
                ),
                (
                    "marche_resilie",
                    models.BooleanField(default=False, verbose_name="Marché résilié"),
                ),
                (
                    "info_supp",
                    models.TextField(
            ...
            options={
                ...
                "ordering": [
                    models.OrderBy(
                        models.F("date_notif_appro"), descending=True, nulls_last=True
                    ),
                    "num_marche",
                ],
                "indexes": [
                    models.Index(
                        fields=["type_budget", "exercice_budgetaire"],
                        name="marche_fich_type_bu_a85d28_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "entite_nant",
                    models.CharField(
                        help_text="Interprété comme la banque en faveur de laquelle le nantissement est constitué (cohérent avec RIB/domiciliation ci-dessous) plutôt que le titulaire du marché -- à confirmer.",
                        max_length=255,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "num_penalite",
                    models.CharField(
                        max_length=50, verbose_name="Numéro de la pénalité"
                    ),
                ),
                ...
                (
                    "motif_penalite",
                    models.TextField(verbose_name="Motif de la pénalité"),
                ),
                (
                    "marche",
                    models.ForeignKey(
